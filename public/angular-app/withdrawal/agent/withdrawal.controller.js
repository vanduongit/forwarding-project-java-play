(function () {
    ...
    angular
        .module('app')
        .controller('AgentWithdrawalController', AgentWithdrawalController);

    AgentWithdrawalController.$inject = ['SessionService'];
    function AgentWithdrawalController(SessionService) {
        var vm = this;
